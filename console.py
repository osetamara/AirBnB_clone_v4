...
def split_curly_braces(e_arg):
    ...
    if curly_braces:
        ...
        id = [j.strip(",") for j in id_with_comma][0]
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_count(self, arg):
        """
        Counts to retrieves the number of instances of a class
    ...
    def do_update(self, arg):
        """
        Update the instance by adding or updating an attribute.
    ...
    def default(self, arg):
        """
        Default behavior for cmd module when input when is invalid
        """
        arg_list = arg.split('.')
